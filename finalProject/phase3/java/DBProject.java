...
public class DBProject {
   ...
   public static void addCustomer(DBProject esql){
	...
	String sql = "insert into customer(customerID, fName, lName, Address, phNo, DOB, gender) values(" + id + "," + "\'" + first_name + "\'" + "," + "\'" + last_name + "\'" + "," + "\'" + address + "\'" + "," + "\'" + phNo + "\'" + "," + "\'" + dob + "\'" + "," + "\'" + gender + "\'" + ")"; 
   ...
   public static void addRoom(DBProject esql){
	...
	String sql = "insert into room(hotelID, roomNo, roomType) values(" + "\'" + hotelID + "\'" +  "," + "\'" + roomNo + "\'" + "," + "\'" + type + "\'" + ")";
   ...
   public static void addMaintenanceCompany(DBProject esql){
	...
	String sql = "insert into maintenancecompany(cmpID, name, address, isCertified) values(" + "\'" + id + "\'" + "," + "\'" + name + "\'" +  "," + "\'" + address  + "\'" + "," + "\'" + certified + "\'" + ")";
   ...
   public static void addRepair(DBProject esql){
	...
	String sql = "insert into repair(rid, hotelID, roomNo, mcompany, repairdate, description, repairtype) values(" + "\'" + id + "\'" + "," + "\'" + hotelID + "\'" +  "," + "\'" + roomNo + "\'" + "," + "\'" + cmpID + "\'" + "," + "\'" + date + "\'" + "," + "\'" + description + "\'" + "," + "\'" + type + "\'" + ")";
	esql.executeUpdate(sql);
	}catch(Exception e){
	System.err.println(e.getMessage());
	}
   ...
   public static void bookRoom(DBProject esql){
	...
	String sql = "insert into booking(bid, customer, hotelID, roomNo, bookingdate, noofpeople, price) values(" + "\'" + id + "\'" + "," + "\'" + cID + "\'" + "," + "\'" + hotelID + "\'" +  "," + "\'" + roomNo + "\'" + "," + "\'" + date + "\'" + "," + "\'" + numPpl + "\'" + "," + "\'" + price + "\'" + ")";
	esql.executeUpdate(sql);
	}catch(Exception e){
	System.err.println(e.getMessage());
	}	
   ...
   public static void assignHouseCleaningToRoom(DBProject esql){
	...
	String sql = "insert into assigned(asgid, staffID, hotelID, roomNo) values(" + "\'" + id + "\'" + "," + "\'" + sID + "\'" + "," + "\'" + hotelID + "\'" +  "," + "\'" + roomNo + "\'" + ")";
	esql.executeUpdate(sql);
	}catch(Exception e){
	System.err.println(e.getMessage());
	}	
   ...
   public static void repairRequest(DBProject esql){
	...
	String sql = "insert into request(reqid, managerID, repairID, requestdate, description) values(" + "\'" + id + "\'" + "," + "\'" + mID + "\'" + "," + "\'" + rID + "\'" +  "," + "\'" + date + "\'" + "," + "\'" + description + "\'" + ")";
	esql.executeUpdate(sql);
	}catch(Exception e){
	System.err.println(e.getMessage());
	}	
